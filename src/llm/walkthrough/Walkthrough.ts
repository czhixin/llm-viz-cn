    ...
    return {
        ...
        phaseList: [{
            ...
            phases: [
                ...
                { id: Phase.Intro_Prelim, title: '准备工作' },
            ],
        }, {
            ...
            phases: [
                ...
                { id: Phase.Input_Detail_LayerNorm, title: '层归一化(Layer Norm)' },
                { id: Phase.Input_Detail_SelfAttention, title: '自注意力机制(Self Attention)' },
                { id: Phase.Input_Detail_Projection, title: '投射(Projection)' },
                { id: Phase.Input_Detail_Mlp, title: '多层感知器(MLP)' },
                { id: Phase.Input_Detail_Transformer, title: '变换器(Transformer)' },
                { id: Phase.Input_Detail_Softmax, title: '归一化指数函数(Softmax)' },
                { id: Phase.Input_Detail_Output, title: '输出(Output)' },
            ],
        }] as IPhaseGroup[],
    };
}
